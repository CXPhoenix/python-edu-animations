    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.__value: ptyping.Any = value
        self.__index: ptyping.Union[str, int] = index
    ...
    def fetch_value(self) -> ptyping.Any:
    ...
    def fetch_index(self) -> ptyping.Union[str, int]:
