...
class MArray(VGroup):
    ...
    **kwargs
    ...
    def __calc_label_pos_and_mob(self) -> ptyping.Tuple[Square, np.ndarray]:
    ...
    def __calc_index(self, index: int) -> ptyping.Union[int, str]:
    ...
    ) -> ptyping.Tuple[Succession, ptyping.Callable[[bool], ptyping.List[Animation]]]:
    ...
    def __init_props(
        ...
        self.__scene: Scene = scene
        self.__arr: ptyping.List[ptyping.Any] = arr
        self.__label: str = label
        self.__mob_arr: ptyping.List[MArrayElement] = []
    ...
    def fetch_mob_arr(self) -> ptyping.List[MArrayElement]:
...
class MArraySlidingWindow(VGroup):
    ...
    **kwargs
    ...
    def __calc_window_dim(self) -> ptyping.Tuple[float, float]:
    ...
    def __calc_window_pos_np(self) -> ptyping.Tuple[np.ndarray, np.ndarray]:
